...
<!--      </el-table-column>-->
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.status === 1" type="text" size="small" @click="updateStatusHandle(scope.row.productId, 0, '下架')">下架</el-button>
          <el-button v-else type="text" size="small" @click="updateStatusHandle(scope.row.productId, 1, '上架')">上架</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
